...
@WebServlet(urlPatterns = "/api/saveFavourite")
public class SaveFavourite extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("INSERT INTO stockist.favourites (UserName, Title, UrlLink)\n" +
                "VALUES (?, ?, ?)");
